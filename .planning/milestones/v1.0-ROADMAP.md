...
- [x] **Phase 5: Semantic Install Onboarding** - TTY-gated y/N install offer for the `semantic` extra with per-repo decline memory; non-TTY paths stay silent (completed 2026-08-23)
...
| 5. Semantic Install Onboarding | 1/1 | Complete    | 2026-08-23 |
