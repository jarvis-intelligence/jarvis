...
- Non-functional: watcher optional (`codeintel watch [path]` command), not a daemon requirement; graph stored in registry.db (single RW database, keeps index.db immutable).
