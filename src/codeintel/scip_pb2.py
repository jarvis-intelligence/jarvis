...
# protoc:  libprotoc 35.0 (via grpcio-tools 7.35.1's bundled protoc)
#
...
# "Protobuf Python Version" pin below (gencode requires runtime >= gencode
# version) — regenerating with a newer protoc means bumping that pin too.
# =============================================================================
